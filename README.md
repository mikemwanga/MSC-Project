...
## Bayesian inference of phylogenies and population dynamics.
BEAST - powerful and flexible tool for evolutionary analysis of molecular sequences
To understand 
    - tmrca
    - evolutionary process
    - tranmissoin dynamics
    - 
